...
for i, v in pairs(game:GetService("Workspace").Map.Mob:GetChildren()) do
...
for i, v in pairs(game:GetService("Workspace").Map.Shop:GetChildren()) do
...
for i, v in pairs(game:GetService("Workspace").Map.Island:GetChildren()) do
...
Tab4:AddButton({"Melee -1M", function()
local args = {
    [1] = "Str",
    [2] = -1000000
}
        ...
        pcall(function()
            if getgenv().Kill then
              ...
              local character = player.Character or player.CharacterAdded:Wait()
                ...
                for _, v in pairs(workspace.Map.Mob:GetDescendants()) do
